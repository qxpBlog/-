...
def parse_arguments():
    ...
    parser.add_argument("--criterion", type=str, default='triplet', help='loss to be used',
                        choices=["triplet", "sare_ind", "sare_joint", "asymmetric", 'new_method'])
    ...
    parser.add_argument("--similarity_topk", type=int, default=10,
                        help="How many neighbors to mine")
    ...
    parser.add_argument("--val_positive_area_threshold", type=int, default=0.1, help="_")
